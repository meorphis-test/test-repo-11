...
import * as AccountsAPI from 'meorphis-test-24/resources/accounts/accounts';
import * as CreditConfigurationAPI from 'meorphis-test-24/resources/accounts/credit-configuration';
